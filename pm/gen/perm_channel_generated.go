...
var PermChannelMap = map[string]string{
    ...
    "func_channel_message_pin": "频道 - 消息 - 置顶",
    "func_channel_message_archive": "频道 - 消息 - 归档",
    "func_channel_message_delete": "频道 - 消息 - 删除",
    "func_channel_message_read_whisper_all": "频道 - 消息 - 查看所有悄悄话",
    "func_channel_iform_manage": "频道 - iForm - 配置管理",
    "func_channel_iform_broadcast": "频道 - iForm - 同步推送",
    "func_channel_theater_view": "频道 - 小剧场 - 查看",
    "func_channel_theater_scene_switch": "频道 - 小剧场 - 切换场景",
    "func_channel_theater_object_edit": "频道 - 小剧场 - 编辑对象",
    "func_channel_theater_character_edit": "频道 - 小剧场 - 编辑角色",
    "func_channel_theater_resource_upload": "频道 - 小剧场 - 上传资源",
    "func_channel_theater_resource_delete": "频道 - 小剧场 - 删除资源",
    "func_channel_theater_action_trigger": "频道 - 小剧场 - 触发动作",
    "func_channel_theater_admin_restore": "频道 - 小剧场 - 管理恢复",
...
var PermChannelArray = []map[string]string{
	...
	{"key": "func_channel_message_pin", "desc": "频道 - 消息 - 置顶"},
	{"key": "func_channel_message_archive", "desc": "频道 - 消息 - 归档"},
	{"key": "func_channel_message_delete", "desc": "频道 - 消息 - 删除"},
	{"key": "func_channel_message_read_whisper_all", "desc": "频道 - 消息 - 查看所有悄悄话"},
	{"key": "func_channel_iform_manage", "desc": "频道 - iForm - 配置管理"},
	{"key": "func_channel_iform_broadcast", "desc": "频道 - iForm - 同步推送"},
	{"key": "func_channel_theater_view", "desc": "频道 - 小剧场 - 查看"},
	{"key": "func_channel_theater_scene_switch", "desc": "频道 - 小剧场 - 切换场景"},
	{"key": "func_channel_theater_object_edit", "desc": "频道 - 小剧场 - 编辑对象"},
	{"key": "func_channel_theater_character_edit", "desc": "频道 - 小剧场 - 编辑角色"},
	{"key": "func_channel_theater_resource_upload", "desc": "频道 - 小剧场 - 上传资源"},
	{"key": "func_channel_theater_resource_delete", "desc": "频道 - 小剧场 - 删除资源"},
	{"key": "func_channel_theater_action_trigger", "desc": "频道 - 小剧场 - 触发动作"},
	{"key": "func_channel_theater_admin_restore", "desc": "频道 - 小剧场 - 管理恢复"},
